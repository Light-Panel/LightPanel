...
(async () => {
  ...
  if (data.accountInfo.permissions.includes('manageContainers')) {
    ...
    const div = page.appendChild(Component.div({ style: { backgroundColor: 'var(--mainColor_dark)', border: '[0.1ps] solid var(--mainColor_border)', borderRadius: '[0.5ps]', marginTop: '[1ps]', marginBottom: '[1ps]', width: 'calc(100vw - [13ps])' }}))
    ...
    const div2 = page.appendChild(Component.div({ style: { backgroundColor: 'var(--mainColor_dark)', border: '[0.1ps] solid var(--mainColor_border)', borderRadius: '[0.5ps]', marginBottom: '[1ps]', width: 'calc(100vw - [13ps])' }}))
    ...
    const div4 = page.appendChild(Component.div({ style: { backgroundColor: 'var(--mainColor_dark)', border: '[0.1ps] solid var(--mainColor_border)', borderRadius: '[0.5ps]', marginBottom: '[1ps]', width: 'calc(100vw - [13ps])' }}))
