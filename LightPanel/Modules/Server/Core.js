...
module.exports = class {
  ...
  constructor (path, options) {
    ...
    this.#path = path
    this.#info = Object.assign(JSON.parse(fs.readFileSync(getPath(__dirname, ['<', 'Info.json']))), { platform: os.platform(), cpus: os.cpus().length/2, toltalMemory: Math.round(os.totalmem()/1048576) })
